...
class Predictor(BasePredictor):
    ...
    def predict(self, 
        ...
        try:
            ...
            raise Exception("Error: Could not get FPS from video")
        ...
        try:
            ...
            raise Exception("Error: Could not extract audio from video")
        try: 
            ####################################### Process Frames #######################################
            ...
            for line in process.stdout:
                print(line, end='')  # Print or process the stdout in real-time
            for line in process.stderr:
                print(line, end='')  # Print or process the stderr in real-time
            process.communicate()  # Wait for the process to finish and handle return code if needed
            if process.returncode != 0:
                print(stderr)
                raise RuntimeError(stderr)
            else:
            ...
            print("Error: Could not Upscale frames")
            raise Exception("Error: Could not Upscale frames")
